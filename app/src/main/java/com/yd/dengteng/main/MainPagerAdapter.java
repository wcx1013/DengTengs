...
public class MainPagerAdapter extends FragmentPagerAdapter {
    ...
    public MainPagerAdapter(FragmentManager fm) {
        ...
        if (PAGE_CONFIG.showHome) {
            ...
            norIcons[lastIndex] = R.drawable.ic_home_nor;
            seleIcons[lastIndex] = R.drawable.ic_home_sele;
        }
        ...
        if (PAGE_CONFIG.showMe) {
            ...
            norIcons[lastIndex] = R.drawable.ic_me_nor;
            seleIcons[lastIndex] = R.drawable.ic_me_sele;
        }
    }
